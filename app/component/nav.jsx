...
export default function nav() {
  return (
    <nav className=" header bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
     
       <h1 className='text-4xl'>get
      ...
      <div
        ...
        id="navbar-sticky"
      >
        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium  rounded-lg text-white md:flex-row  md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <Link
              href="/"
        ...
        <Button name='register' className='btn'/>
      </div>
    </div>
  </nav>
  )
